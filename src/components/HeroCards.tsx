...
export const HeroCards = () => {
  return (
    ...
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-full max-w-[700px] h-[500px]">
      ...
      {/* Team */}
  <Card className="absolute right-[20px] top-4 w-80 flex flex-col justify-center items-center drop-shadow-xl shadow-black/10 border-none">
      ...
      {/* E-commerce */}
  <Card className="absolute top-[150px] left-[20px] w-72 drop-shadow-xl shadow-black/10 border-none">
        <CardHeader>
      ...
      {/* IA Solutions */}
  <Card className="absolute w-[350px] -right-[10px] bottom-[35px] drop-shadow-xl shadow-black/10 border-none">
